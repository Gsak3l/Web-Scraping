...
class testing_stuff:
    ...
    def getting_mail(self, email_list):
        bot = self.bot
    ...
    def check_working(self):
        bot = self.bot
        bot.get('http://ismyemailworking.com/')
        time.sleep(3)
        bot.find_element_by_xpath('//*[@id="verify_email"]').send_keys(email[0])
        bot.find_element_by_xpath('//*[@id="content_cob_check"]').click()
        bot.close()
...
class Sign_Up_Bot:
    ...
    def get_email(self, email_list):
        ...
        time.sleep(3)
        bot.switch_to.frame(bot.find_element_by_xpath('//*[@id="iframe"]'))
        print(bot.find_element_by_xpath('/html/body/table/tbody/tr[2]/td/table[2]/tbody/tr[1]/td[2]/table/tbody/tr[7]/td/strong').text)
    ...
    def create_twitter_account(self, error_list):
        bot = self.bot
