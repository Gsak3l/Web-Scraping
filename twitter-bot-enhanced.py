...
if __name__ == '__main__':
    ...
    # bot2 = Sign_Up_Bot()
    bot3 = Sign_Up_Bot()
    process1 = multiprocessing.Process(target=bot1.get_full_name, )
    # process2 = multiprocessing.Process(target=bot2.get_email, )
    process3 = multiprocessing.Process(target=bot3.get_password, )
    process1.start()
    # process2.start()
    process3.start()
    process1.join()
