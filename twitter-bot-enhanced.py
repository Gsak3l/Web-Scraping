...
class test:
    ...
    def testtt(self):
        bot = self.bot
        bot.get('https://inspirobot.me/')
        bot.find_element_by_xpath('/html/body/div[2]/div[1]/div[1]/div[2]/div/div[2]').click()
        time.sleep(5)
        img = bot.find_element_by_xpath('/html/body/div[2]/div[1]/div[1]/div[1]/img')
...
if __name__ == '__main__':
    ...
    # tweeting
    # bot7 = Tweet_Bot()
    # bot7.tweet_inspirational_quote(email[0], password[0])
    # bot7.follow_random_users(email[0], password[0])
    botx = test()
    botx.testtt()
